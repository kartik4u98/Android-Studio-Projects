package com.masterflow.masterflow;
...
import com.masterflow.masterflow.dummy.DummyContent;
...
public class WebpagesDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ...
            view.getSettings().setJavaScriptEnabled(true); //for some web using JavaScript like "youtube.com"
